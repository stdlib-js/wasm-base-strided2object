...
```javascript
strided2object = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/wasm-base-strided2object@v0.1.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/wasm-base-strided2object@v0.1.0-umd/browser.js"></script>
```
