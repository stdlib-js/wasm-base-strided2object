...
```javascript
import strided2object from 'https://cdn.jsdelivr.net/gh/stdlib-js/wasm-base-strided2object@v0.1.0-esm/index.mjs';
```
...
[@stdlib/wasm/base/dtype2wasm]: https://github.com/stdlib-js/wasm-base-dtype2wasm/tree/esm
